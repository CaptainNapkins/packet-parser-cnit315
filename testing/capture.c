...
void my_callback(u_char *useless,const struct pcap_pkthdr* pkthdr,const u_char*  packet) {
    ...
    // Implement other protocols once i get this to work
    // should probably print to make sure we are getting the info right
    // then we'll need a function to parse thru and print packet data
    switch (iphdr->ip_p) {
        case IPPROTO_TCP: {
